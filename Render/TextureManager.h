...
public:
    ...
    Texture* init1D(const std::string &name, int w, int numFrames = 1);
    Texture* init2D(const std::string &name, int w, int h, int numFrames = 1);
    Texture* init3D(const std::string &name, int w, int h, int d, int numFrames = 1);
    Texture* initCube(const std::string &name, int w, int h, int numFrames = 1);
...
private:
    ...
    bool init1D(Texture *tex, const std::string &name, int w, int frames = 1);
    bool init2D(Texture *tex, const std::string &name, int w, int h, int frames = 1);
    bool init3D(Texture *tex, const std::string &name, int w, int h, int d, int frames = 1);
    bool initCube(Texture *tex, const std::string &name, int w, int h, int frames = 1);
