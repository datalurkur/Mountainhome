...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.9.1/x86_64-darwin10.7.0")
  ...
  CONFIG["INSTALL"] = '/Users/loch/local/bin/ginstall -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/loch/Downloads/ruby-1.9.2-p136/install_dir")
  ...
  CONFIG["configure_args"] = " '--enable-shared' '--prefix=/Users/loch/Downloads/ruby-1.9.2-p136/install_dir/'"
  CONFIG["vendordir"] = "$(rubylibprefix)/vendor_ruby"
  CONFIG["sitedir"] = "$(rubylibprefix)/site_ruby"
  CONFIG["ruby_version"] = "1.9.1"
  CONFIG["sitearch"] = "$(arch)"
  CONFIG["arch"] = "x86_64-darwin10.7.0"
  ...
  CONFIG["DOT"] = "dot"
  CONFIG["MAKEDIRS"] = "/Users/loch/local/bin/gmkdir -p"
  CONFIG["MKDIR_P"] = "/Users/loch/local/bin/gmkdir -p"
  ...
  CONFIG["CC"] = "gcc"
  CONFIG["target_os"] = "darwin10.7.0"
  CONFIG["target_vendor"] = "apple"
  CONFIG["target_cpu"] = "x86_64"
  CONFIG["target"] = "x86_64-apple-darwin10.7.0"
  CONFIG["host_os"] = "darwin10.7.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "i386"
  CONFIG["host"] = "i386-apple-darwin10.7.0"
  CONFIG["build_os"] = "darwin10.7.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "i386"
  CONFIG["build"] = "i386-apple-darwin10.7.0"
