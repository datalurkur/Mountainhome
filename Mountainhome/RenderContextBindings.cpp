    ...
    "RenderContextBindings")
{
    ...
    rb_define_method(_class, "set_global_ambient", RUBY_METHOD_FUNC(RenderContextBindings::SetGlobalAmbient), 4);
...
VALUE RenderContextBindings::SetGlobalAmbient(VALUE rSelf, VALUE r, VALUE g, VALUE b, VALUE a) {
    RenderContext *cSelf = Get()->getPointer(rSelf);
    cSelf->setGlobalAmbient(Color4(NUM2DBL(r), NUM2DBL(g), NUM2DBL(b), NUM2DBL(a)));
    return Qnil;
}
