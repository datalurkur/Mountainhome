...
class GameState < MHState
    ...
    def setup(world)
        ...
        @evt.register_action(:open_dwarves_menu) {
            if @dwarves_menu.nil?
        ...
        @evt.register_action(:open_save_dialog) {
