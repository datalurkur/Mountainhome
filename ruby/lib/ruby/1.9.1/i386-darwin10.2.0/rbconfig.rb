...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/ajean/personal/duergar/Mountainhome/ruby")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/ajean/personal/duergar/Mountainhome/ruby'"
  ...
  CONFIG["CFLAGS"] = " $(cflags) -pipe -fno-common"
  CONFIG["CC"] = "gcc"
